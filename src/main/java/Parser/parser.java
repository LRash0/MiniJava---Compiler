...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Mar 19 15:23:07 BRT 2018
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\025\000\006\004\006\012\010\001\002\000\010\002" +
    "\027\004\006\012\010\001\002\000\010\002\ufffe\004\ufffe" +
    "\012\ufffe\001\002\000\006\007\016\012\015\001\002\000" +
    "\010\002\001\004\001\012\001\001\002\000\004\006\ufffb" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\025\000\014\002\003\003\006\004\004\005\010\007" +
    "\011\001\001\000\012\003\025\004\004\005\010\007\011" +
      ...
      switch (CUP$parser$act_num)
		...
		String name = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new IdentifierExp(name, nameleft); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 7: // ReturnStatement ::= RETURN Expression SEMICOLON 
            {
              Return RESULT =null;
		...
		Exp expr = (Exp)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new Return(expr, rleft); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("ReturnStatement",3, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		Exp expr = (Exp)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new Assign(id, expr, idleft); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 4: // Statement ::= ReturnStatement 
            {
